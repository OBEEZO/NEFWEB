...
@php
    $pageTitle = 'Events';
    $pageDescription = 'Create a new event and share details with your audience.';
@endphp
...
<div class="container-xxl py-5">
    <div class="container">
        <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Create Event</h1>
        <div class="row g-4 no-gutters">
            <div class="col-md-12">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form class="mx-auto" method="POST" enctype="multipart/form-data" action="{{ route('event-store') }}">
                        @csrf
                        ...
                        <div class="row mx-auto">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="event_title" placeholder="e.g., Charity Run 2025" required
                        ...
                        <button class="btn btn-primary mx-auto px-3" type="submit">Submit Event</button>
                    </form>
                </div>
            </div>
        </div>
