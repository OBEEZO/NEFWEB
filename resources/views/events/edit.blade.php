...
<div class="container-xxl py-5">
    ...
    <div class="container">
        <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Update: {{ $event->title }}</h1>
        <div class="row g-4 no-gutters">
            <div class="col-md-12">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form class="mx-auto" method="POST" enctype="multipart/form-data" action="{{ route('update-event', $event->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <button class="btn btn-primary mx-auto px-3" type="submit">Update Event</button>
                    </form>
                </div>
            </div>
        </div>
