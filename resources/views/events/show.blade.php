            ...
            <div class="col-lg-12">
                <div class="d-flex align-items-center mb-5">
                    <img 
                        ...
                        src="{{ $event->image ? asset('storage/' . $event->image) : asset('assets/img/no-image.png') }}" 
                        alt="Event Image" 
                        style="width: 100px; height: 100px; object-fit: cover;"
                    >
                    <div class="text-start ps-4">
                        <h3 class="mb-3">{{ $event->title }}</h3>
                        <p class="text-muted"><strong>Date:</strong> {{ \Carbon\Carbon::parse($event->date)->format('F d, Y') }}</p>
                    </div>
                </div>
